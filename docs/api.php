...
<h1>1. <a name="Contents"></a>Contents</h1>
	...
	<ol>
		...
		<li><a href="#Initialization">Initialization Functions</a>	<ol>
		<li>glutInit</li>
		...
		<li><a href="#EventProcessing">Event Processing Functions</a>	<ol>
		<li>glutMainLoop</li>
		<li>glutMainLoopEvent</li>
		<li>glutLeaveMainLoop</li>
	</ol>
		<li><a href="#Window">Window Functions</a>	<ol>
		...
		<li><a href="#Display">Display Functions</a>	<ol>
		...
		<li><a href="#Overlay">Overlay Functions</a>	<ol>
		...
		<li><a href="#Menu">Menu Functions</a>	<ol>
		...
		<li><a href="#GlobalCallback">Global Callback Registration Functions</a>	<ol>
		<li>glutTimerFunc</li>
		<li>glutIdleFunc</li>
		<li>glutMenuStatusFunc</li>
		<li>glutMenuStateFunc</li>
	</ol>
		<li><a href="#WindowCallback">Window-Specific Callback Registration Functions</a>	<ol>
		...
		<li><a href="#StateSetting">State Setting and Retrieval Functions</a>	<ol>
		<li>glutSetOption</li>
		<li>glutGet</li>
		<li>glutDeviceGet</li>
		...
		<li><a href="#FontRendering">Font Rendering Functions</a>	<ol>
		...
		<li><a href="#GeometricObject">Geometric Object Rendering Functions</a>	<ol>
		<li>glutWireSphere, glutSolidSphere</li>
		<li>glutWireTorus, glutSolidTorus</li>
		<li>glutWireCylinder, glutSolidCylinder</li>
	...
	<ol>
		...
		<li><a href="#ColorMap">Color Map Functions</a>	<ol>
		<li>glutSetColor, glutGetColor</li>
		<li>glutCopyColormap</li>
	</ol>
		<li><a href="#MultiTouch">MultiTouch Functions</a>	<ol>
		...
		<li><a href="#Mobile">Mobile Functions</a></li>
		<li><a href="#Miscellaneous">Miscellaneous Functions</a>	<ol>
		<li>glutSetKeyRepeat, glutIgnoreKeyRepeat</li>
		<li>glutForceJoystickFunc</li>
		<li>glutReportErrors</li>
	</ol>
		<li><a href="#UsageNotes">Usage Notes</a>	<ol>
		<li>Implementation Notes</li>
		<li>GLUT State</li>
		<li>"freeglut.h" Header File</li>
		<li>References</li>
		<li>Index	</ol>
	</ol>
...
he allowed people to write truly portable OpenGL applications.</p>
...
having moved on to bigger and better things, this started to become a problem.</p>
...
specifies the application program interface to the <i>freeglut</i> library.</p>

<h2>3.1 <a name="31-design-philosophy"></a>Design Philosophy</h2>
...
and their compatibility with GLUT, are made explicit.</p>

<h3>3.2.1 <a name="321-window-placement-and-size"></a>Window placement and size</h3>
...
<i>freeglut</i>, we decided to break with GLUT's behaviour.</p>
...
the following conventions, both under Windows and under UNIX/X11:</p>
...
always supports negative window coordinates.<br>
</li>
...
specified when the window was created.</li>
</ul>
...
<h3>3.2.2 <a name="322-userdata-callbacks"></a>User-data callbacks</h3>
...
callbacks are marked as such.</p>
...
<p>
<tt>void glutPositionFunc ( void (* func)( int x, int y ) );</tt></p>

<p>
<tt>void glutPositionFuncUcall ( void (* func)( int x, int y, void* user_data ), void* user_data );</tt></p>

<p>
<tt>void glutKeyboardUpFunc ( void (* func)( unsigned char key, int x, int y ) );</tt></p>

<p>
<tt>void glutKeyboardUpFuncUcall ( void (* func)( unsigned char key, int x, int y, void* user_data ), void* user_data );</tt></p>

<h2>3.3 <a name="33-terminology"></a>Terminology</h2>

<h2>3.4 <a name="34-differences-from-glut-37"></a>Differences from GLUT 3.7</h2>
...
<h3>3.4.1 <a name="341-glutmainloop-behaviour"></a>glutMainLoop Behaviour</h3>
...
<h3>3.4.2 <a name="342-action-on-window-closure"></a>Action on Window Closure</h3>
...
GLUT should simply exit (the default).</p>

<h3>3.4.3 <a name="343-fullscreen-windows"></a>Fullscreen windows</h3>

<p>
Function to leave fullscreen window mode, <tt>glutLeaveFullScreen</tt>,
or to toggle between fullscreen and normal window mode,
<tt>glutFullScreenToggle</tt>, have been added.</p>

<h3>3.4.4 <a name="344-changes-to-callbacks"></a>Changes to Callbacks</h3>
...
callback he should contact the <i>freeglut</i> development team.</p>

<h3>3.4.5 <a name="345-string-rendering"></a>String Rendering</h3>
...
pixels for bitmapped fonts and in OpenGL units for the stroke fonts.</p>

<h3>3.4.6  <a name="346-geometry-rendering"></a>Geometry Rendering</h3>
...
generated for the teaset.</p>

<h3>3.4.7  <a name="347-extension-function-queries"></a>Extension Function Queries</h3>
...
<h2>4.1 <a name="41-glutinit"></a>glutInit</h2>

<h2>4.2 <a name="42-glutinitwindowposition-glutinitwindowsize"></a>glutInitWindowPosition, glutInitWindowSize</h2>
...
<p>
<tt>void glutInitWindowPosition ( int x, int y );</tt></p>
...
but it certainly makes an attempt to.</p>
...
on the top.  The border and title bar are commonly called "decorations."</p>
...
about this window manager discretion.</p>

<p>
<b>On Windows</b>, the positioning behavior is more predictable, with the
window frame being positioned at the requested coordinates.</p>
...
negative coordinates and sizes are interpreted for subwindows.</p>
...
call <tt>glutReshapeWindow</tt> and make a window narrower again.</p>

<p>
If GLUT_ALLOW_NEGATIVE_WINDOW_POSITION is enabled, <tt>glutInitWindowPosition</tt>
will accept negative window coordinates.</p>

<h2>4.3 <a name="43-glutinitdisplaymode"></a>glutInitDisplayMode</h2>

<h2>4.4 <a name="44-glutinitdisplaystring"></a>glutInitDisplayString</h2>
...
<h2>4.5 <a name="45-glutiniterrorfunc-glutinitwarningfunc"></a>glutInitErrorFunc, glutInitWarningFunc</h2>
...
avoid exit(1) being called upon error. As with other glutInit<i>
functions, these can be set before glutInit is called, so any output
from the library can be handled by the user.</i></p>

<p>
<b>Usage</b></p>

<p>
<tt>void glutInitErrorFunc   ( void (* callback)( const char *fmt, va_list ap) );</tt></p>

<p>
<tt>void glutInitWarningFunc ( void (* callback)( const char *fmt, va_list ap) );</tt></p>

<p>
These functions have user-data callback functions.</p>
...
list that can be passed to functions such as <tt>printf</tt>.</p>
...
are printed to <tt>stderr</tt> when no callback is defined.</p>

<p>
<b>Changes From GLUT</b></p>

<p>
GLUT does not provide these functions.</p>
...
to the application's calling <tt>exit</tt> from within a GLUT callback.</p>

<h2>5.1 <a name="51-glutmainloop"></a>glutMainLoop</h2>

<p>
The <tt>glutMainLoop</tt> function enters the event loop.</p>

<p>
<b>Usage</b></p>

<p>
<tt>void glutMainLoop ( void );</tt></p>

<p>
<b>Description</b></p>

<p>
The <tt>glutMainLoop</tt> function
...
<h2>5.2  <a name="52-glutmainloopevent"></a>glutMainLoopEvent</h2>

<p>
The <tt>glutMainLoopEvent</tt> function processes a single iteration
in the <i>freeglut</i> event loop.</p>

<p>
<b>Usage</b></p>

<p>
<tt>void glutMainLoopEvent ( void );</tt></p>
...
to control its own event loop and still use the <i>freeglut</i> windowing system.</p>
...
<h2>5.3  <a name="53-glutleavemainloop"></a>glutLeaveMainLoop</h2>
...
<p>
<tt>void glutLeaveMainLoop ( void );</tt></p>
...
<h2>6.1 <a name="61-glutcreatewindow"></a>glutCreateWindow</h2>

<h2>6.2 <a name="62-glutcreatesubwindow"></a>glutCreateSubwindow</h2>

<p>
The <tt>glutCreateSubwindow</tt> function creates a subwindow of an existing window.</p>

<p>
<b>Usage</b></p>

<p>
<tt>int glutCreateSubwindow(int window, int x, int y, int width, int height);</tt></p>
...
subwindow will have a size of 20. If <i>width</i> is -20, then the subwindow will have a width of 70 <tt>(parent - pos - abs(dim))</tt>.</p>
...
and the <i>x</i> is 10, and <i>width</i> is 20, the subwindow will have a size of 20. If <i>width</i> is -20, then the subwindow will have a width of 80 <tt>(parent - abs(dim))</tt>.</p>
...
which changes the the functionality of <tt>glutCreateSubwindow</tt>.</p>

<h2>6.3 <a name="63-glutdestroywindow"></a>glutDestroyWindow</h2>

<h2>6.4 <a name="64-glutsetwindow-glutgetwindow"></a>glutSetWindow, glutGetWindow</h2>

<h2>6.5 <a name="65-glutsetwindowtitle-glutseticontitle"></a>glutSetWindowTitle, glutSetIconTitle</h2>
...
an iconified state respectively.</p>

<p>
<b>Usage</b></p>

<p>
<tt>glutSetWindowTitle(const char* title);</tt></p>

<p>
<tt>glutSetIconTitle(const char* title);</tt></p>
...
when you open the window with glutCreateWindow().</p>

<p>
<tt>glutSetIconTitle</tt> sets the title to be displayed for the window
when it is in iconified (minimized) state.</p>

<p>
<b>Changes From GLUT</b></p>

<p>
<tt>glutSetIconTitle</tt> does nothing in GLUT on Windows, but is
emulated on Windows by <i>freeglut</i>.</p>

<h2>6.6 <a name="66-glutreshapewindow"></a>glutReshapeWindow</h2>

<h2>6.7 <a name="67-glutpositionwindow"></a>glutPositionWindow</h2>

<h2>6.8 <a name="68-glutshowwindow-gluthidewindow-gluticonifywindow"></a>glutShowWindow, glutHideWindow, glutIconifyWindow</h2>

<h2>6.9 <a name="69-glutpushwindow-glutpopwindow"></a>glutPushWindow, glutPopWindow</h2>

<h2>6.10 <a name="610-glutfullscreen-glutleavefullscreen-glutfullscreentoggle"></a>glutFullScreen, glutLeaveFullScreen, glutFullScreenToggle</h2>

<p>
The <tt>glutFullScreen</tt>, <tt>glutLeaveFullScreen</tt> and
<tt>glutFullScreenToggle</tt> functions are used to transition the
current window between fullscreen and normal mode.</p>

<p>
<b>Usage</b></p>

<p>
<tt>void glutFullScreen ( void );</tt></p>

<p>
<tt>void glutLeaveFullScreen ( void );</tt></p>

<p>
<tt>void glutFullScreenToggle ( void );</tt></p>
...
become fullscreen on the monitor that it overlaps the most.</p>

<p>
Calls to these functions are ignored for gamemode and child windows.</p>
...
<p>
GLUT does not include the <tt>glutLeaveFullScreen</tt> and
<tt>glutFullScreenToggle</tt> functions.</p>

<h1>7. <a name="Display"></a>Display Functions</h1>

<h2>7.1 <a name="71-glutpostredisplay"></a>glutPostRedisplay</h2>
...
<h2>8.1 <a name="81-glutsetcursor"></a>glutSetCursor</h2>

<h2>8.2 <a name="82-glutwarppointer"></a>glutWarpPointer</h2>
...
<i>freeglut</i> without modification.</p>
...
<h2>9.1  <a name="91-glutestablishoverlay"></a>glutEstablishOverlay</h2>

<p>
The <tt>glutEstablishOverlay</tt> function is not implemented in <i>freeglut</i>.</p>

<p>
<b>Usage</b></p>

<p>
<tt>void glutEstablishOverlay ( void );</tt></p>
...
<p>
GLUT implements this function.</p>

<h2>9.2  <a name="92-glutremoveoverlay"></a>glutRemoveOverlay</h2>

<p>
The <tt>glutRemoveOverlay</tt> function is not implemented in <i>freeglut</i>.</p>

<p>
<b>Usage</b></p>

<p>
<tt>void glutRemoveOverlay ( void );</tt></p>
...
<h2>9.3  <a name="93-glutuselayer"></a>glutUseLayer</h2>

<p>
The <tt>glutUseLayer</tt> function is not implemented in <i>freeglut</i>.</p>

<p>
<b>Usage</b></p>

<p>
<tt>void glutUseLayer ( GLenum layer );</tt></p>
...
<h2>9.4 <a name="94-glutpostoverlayredisplay"></a>glutPostOverlayRedisplay</h2>

<p>
The <tt>glutPostOverlayRedisplay</tt> function is not implemented in <i>freeglut</i>.</p>

<p>
<b>Usage</b></p>

<p>
<tt>void glutPostOverlayRedisplay ( void );</tt></p>
...
<h2>9.5  <a name="95-glutpostwindowoverlayredisplay"></a>glutPostWindowOverlayRedisplay</h2>
...
<p>
<tt>void glutPostWindowOverlayRedisplay ( int window );</tt></p>

<p>
<b>Description</b></p>

<p>
The <tt>glutPostWindowOverlayRedisplay</tt> function is not implemented in <i>freeglut</i>.</p>
...
<h2>9.6 <a name="96-glutshowoverlay-gluthideoverlay"></a>glutShowOverlay, glutHideOverlay</h2>

<p>
The <tt>glutShowOverlay</tt> and <tt>glutHideOverlay</tt> functions
are not implemented in <i>freeglut</i>.</p>

<p>
<b>Usage</b></p>

<p>
<tt>void glutShowOverlay( void );</tt></p>

<p>
<tt>void glutHideOverlay( void );</tt></p>

<p>
<b>Description</b></p>

<p>
The <tt>glutShowOverlay</tt> and <tt>glutHideOverlay</tt> functions are not implemented in <i>freeglut</i>.</p>

<p>
<b>Changes From GLUT</b></p>

<p>
GLUT implements these functions.</p>

<h1>10. <a name="Menu"></a>Menu Functions</h1>

<h2>10.1 <a name="101-glutcreatemenu"></a>glutCreateMenu</h2>

<p>
Has user-data callback function.</p>

<h2>10.2 <a name="102-glutdestroymenu"></a>glutDestroyMenu</h2>

<h2>10.3 <a name="103-glutgetmenu-glutsetmenu"></a>glutGetMenu, glutSetMenu</h2>

<h2>10.4 <a name="104-glutaddmenuentry"></a>glutAddMenuEntry</h2>

<h2>10.5 <a name="105-glutaddsubmenu"></a>glutAddSubMenu</h2>

<h2>10.6 <a name="106-glutchangetomenuentry"></a>glutChangeToMenuEntry</h2>

<h2>10.7 <a name="107-glutchangetosubmenu"></a>glutChangeToSubMenu</h2>

<h2>10.8 <a name="108-glutsetmenufont"></a>glutSetMenuFont</h2>

<p>
<tt>glutSetMenuFont</tt> sets the (bitmap) font to be used for drawing
the specified menu.</p>

<p>
<b>Usage</b></p>

<p>
<tt>void glutSetMenuFont( int menuID, void* fontID );</tt></p>

<p>
<b>Description</b></p>

<p>
Only bitmap fonts (<tt>GLUT_BITMAP_xxx</tt>, see <a href="#FontRendering">here</a> for a list) can be used as menu fonts.  A
warning is issued and the request is ignored if the supplied font is a
stroke font, or an unknown font.</p>

<p>
<b>Changes From GLUT</b></p>

<p>
GLUT does not provide this function.</p>

<h2>10.9 <a name="109-glutremovemenuitem"></a>glutRemoveMenuItem</h2>

<h2>10.10 <a name="1010-glutattachmenu-glutdetachmenu"></a>glutAttachMenu, glutDetachMenu</h2>

<h2>10.11 <a name="1011-glutmenudestroyfunc"></a>glutMenuDestroyFunc</h2>
...
<h2>11.1 <a name="111-gluttimerfunc"></a>glutTimerFunc</h2>

<p>
Has user-data callback function.</p>

<h2>11.2 <a name="112-glutidlefunc"></a>glutIdleFunc</h2>

<p>
The <tt>glutIdleFunc</tt> function sets the global idle callback. <i>
freeglut</i>  calls the idle callback when there are no inputs from the user.</p>

<p>
<b>Usage</b></p>

<p>
<tt>void glutIdleFunc ( void (*func ) ( void ) );</tt></p>

<p>
<tt>func</tt> The new global idle callback function</p>
...
and not rely on its current setting.</p>
...
the <tt>glutDisplayFunc</tt> callback.</p>
...
<h2>11.3 <a name="113-glutmenustatusfunc"></a>glutMenuStatusFunc</h2>

<p>
Has user-data callback function.</p>

<h2>11.4 <a name="114-glutmenustatefunc"></a>glutMenuStateFunc</h2>

<h1>12. <a name="WindowCallback"></a>Window-Specific Callback Registration Functions</h1>

<h2>12.1 <a name="121-glutdisplayfunc"></a>glutDisplayFunc</h2>

<p>
Has user-data callback function.</p>

<h2>12.2 <a name="122-glutoverlaydisplayfunc"></a>glutOverlayDisplayFunc</h2>

<p>
Has user-data callback function.</p>

<h2>12.3 <a name="123-glutreshapefunc"></a>glutReshapeFunc</h2>

<p>
Has user-data callback function.</p>

<h2>12.4 <a name="124-glutpositionfunc"></a>glutPositionFunc</h2>
...
repositioned/moved programatically or by the user.</p>

<p>
<b>Usage</b></p>

<p>
<tt>void glutPositionFunc ( void
...
<p>
When <i>freeglut</i> calls this callback, it attempts to provide the new
...
<p>
This function is not implemented in GLUT.</p>

<h2>12.5 <a name="125-glutclosefunc"></a>glutCloseFunc</h2>
...
<p>
<tt>void glutCloseFunc ( void (*func) ( void ) );</tt></p>

<p>
<tt>func</tt> The window's new closure callback function</p>
...
thus be retrieved in the callback using <tt>glutGetWindow</tt>.</p>
...
application from exiting when a window is closed.</p>

<p>
Please note that <tt>glutWMCloseFunc</tt>, a deprecated function, is an
alias to <tt>glutCloseFunc</tt>.</p>
...
<h2>12.6 <a name="126-glutkeyboardfunc"></a>glutKeyboardFunc</h2>

<p>
Has user-data callback function.</p>

<h2>12.7 <a name="127-glutspecialfunc"></a>glutSpecialFunc</h2>
...
user presses a special key.</p>

<p>
<b>Usage</b></p>

<p>
<tt>void glutSpecialFunc ( void (*func)
( int key, int x, int y ) );</tt></p>

<p>
<tt>func </tt>The window's
new special key press callback function</p>

<p>
<tt>key </tt>The
key whose press triggers the callback</p>
...
key.  The Delete key is considered to be a regular key.</p>
...
<h2>12.8 <a name="128-glutkeyboardupfunc"></a>glutKeyboardUpFunc</h2>
...
<p>
<tt>void glutKeyboardUpFunc ( void (*func)
( unsigned char key, int x, int y ) );</tt></p>

<p>
<tt>func </tt>The window's
new key release callback function</p>

<p>
<tt>key </tt>The
key whose release triggers the callback</p>
...
127 for <tt>key</tt>.
Calling <tt>glutKeyboardUpFunc</tt> with
a NULL argument disables the call to the window's key release callback.</p>
...
<h2>12.9 <a name="129-glutspecialupfunc"></a>glutSpecialUpFunc</h2>
...
<p>
<tt>void glutSpecialUpFunc ( void (*func)
( int key, int x, int y ) );</tt></p>

<p>
<tt>func </tt>The window's
new special key release callback function</p>
...
<h2>12.10 <a name="1210-glutmotionfunc-glutpassivemotionfunc"></a>glutMotionFunc, glutPassiveMotionFunc</h2>

<p>
Both functions have user-data callback functions.</p>

<h2>12.11 <a name="1211-glutmousefunc"></a>glutMouseFunc</h2>

<p>
Has user-data callback function.</p>

<h2>12.12 <a name="1212-glutmousewheelfunc"></a>glutMouseWheelFunc</h2>
...
spins the mouse wheel.</p>

<p>
<b>Usage</b></p>

<p>
<tt>void glutMouseWheelFunc ( void( *callback )( int wheel, int
...
<p>
If the mouse wheel is spun over your (sub)window, <i>freeglut</i>
...
<h2>12.13 <a name="1213-glutentryfunc"></a>glutEntryFunc</h2>

<p>
Has user-data callback function.</p>

<h2>12.14 <a name="1214-glutjoystickfunc"></a>glutJoystickFunc</h2>

<p>
Has user-data callback function.</p>

<h2>12.15 <a name="1215-glutspaceballmotionfunc"></a>glutSpaceballMotionFunc</h2>
...
<p>
The <tt>glutSpaceballMotionFunc</tt> function sets the window's Spaceball motion callback. <i>freeglut</i> invokes this callback when the user push/pull Spaceball cap in <i>x</i>, <i>y</i>, and <i>z</i> directions.</p>

<p>
<b>Usage</b></p>

<p>
<tt>void glutSpaceballMotionFunc ( void (* callback)( int x, int y, int z ) );</tt></p>
...
<p>
The <i>x</i>, <i>y</i>, and <i>z</i> arguments indicate the amount of translation in integer along x, y, and z axis respectively.</p>

<p>
The x, y, and z axes form a common OpenGL right-handed coordinate system. A positive value of <i>x</i>, <i>y</i>, or <i>z</i> indicates movement along the positive direction of the respective axis, while the negative one denotes movement along negative direction.</p>

<h2>12.16 <a name="1216-glutspaceballrotatefunc"></a>glutSpaceballRotateFunc</h2>
...
<p>
The <tt>glutSpaceballRotateFunc</tt> function sets the window's Spaceball rotation callback. <i>freeglut</i> invokes this callback when the user rotates/twists Spaceball cap.</p>

<p>
<b>Usage</b></p>

<p>
<tt>void glutSpaceballRotateFunc ( void (* callback)( int rx, int ry, int rz ) );</tt></p>
...
<p>
The <i>rx</i>, <i>ry</i>, and <i>rz</i> arguments indicate the amount of rotation in integer with respect to x, y, and z axis respectively.</p>

<p>
The x, y, and z axes form a common OpenGL right-handed coordinate system. Positive value of <i>rx</i>, <i>ry</i>, or <i>rz</i> indicates counter-clock wise rotation along the respective axis, while negative one denotes clock wise rotation.</p>

<h2>12.17 <a name="1217-glutspaceballbuttonfunc"></a>glutSpaceballButtonFunc</h2>
...
<p>
The <tt>glutSpaceballButtonFunc</tt> function sets the window's Spaceball button callback. <i>freeglut</i> invokes this callback when the user presses/releases one of the Spaceball buttons.</p>

<p>
<b>Usage</b></p>

<p>
<tt>void glutSpaceballButtonFunc ( void (* callback)( int button, int updown ) );</tt></p>
...
<p>
The <i>button</i> argument may take one of the following defined
constant values:</p>
...
<p>
The <i>updown</i> argument may take one of the two defined constant
values:</p>

<ul>
	<li>GLUT_DOWN, GLUT_UP indicating if button is pressed or released.</li>
</ul>
...
<h2>12.18 <a name="1218-glutbuttonboxfunc"></a>glutButtonBoxFunc</h2>

<p>
The <tt>glutDialsFunc</tt> function sets the global dials&buttons box callback. freeglut calls the callback when there is input from the box buttons.</p>

<p>
<b>Usage</b></p>

<p>
<tt>void glutButtonBoxFunc ( void (* callback)( int button, int updown ) );</tt></p>
...
<p>
The <tt>glutDialsFunc</tt> function sets the global dials&buttons box callback. freeglut calls the callback when there is input from the box dials.</p>

<p>
<b>Usage</b></p>

<p>
<tt>void glutDialsFunc ( void (* callback)( int dial, int value ) );</tt></p>
...
that a call to the function will not produce an error..</p>

<p>
<b>Usage</b></p>

<p>
<tt>void glutTabletMotionFunc ( void (* callback)( int x, int y ) );</tt></p>
...
<p>
The <tt>glutTabletMotionFunc</tt> function
is not implemented in <i>freeglut</i>.</p>
...
<h2>12.21 <a name="1221-gluttabletbuttonfunc"></a>glutTabletButtonFunc</h2>
...
<p>
<tt>void glutTabletButtonFunc ( void (* callback)( int button, int updown, int x, int y ) );</tt></p>
...
<h2>12.22 <a name="1222-glutvisibilityfunc-glutwindowstatusfunc"></a>glutVisibilityFunc, glutWindowStatusFunc</h2>
...
these callbacks when the visibility status of a window changes.</p>

<p>
<b>Usage</b></p>

<p>
<tt>void glutVisibilityFunc ( void( *callback )( int state ));</tt></p>

<p>
<tt>void glutWindowStatusFunc ( void( *callback )( int state ));</tt></p>
...
informative <tt>glutWindowStatusFunc</tt>.</p>
...
further rendering to the window is discarded.</p>

<p>
GLUT considers a window visible if any pixel of the window is visible or
any pixel of any descendant window is visible on the screen.</p>
...
window status change will be reported.</p>
...
<h2>13.1 <a name="131-glutsetoption"></a>glutSetOption</h2>

<p>
Allows you to set some general state/option variables.</p>

<p>
<b>Usage</b></p>

<p>
<tt>void glutSetOption ( GLenum eWhat, int value );</tt></p>

<p>
<b>Description</b></p>

<p>
Stores the <tt>value</tt> into a state variable named by
<tt>eWhat</tt>.</p>

<p>
The following state variables can be set:</p>
...
windows if GLUT_MULTISAMPLE was set in the displayMode.</li>
	<li>GLUT_GEOMETRY_VISUALIZE_NORMALS - Set whether <a href="#GeometricObject"><i>freeglut</i>'s geometric object rendering
...
<h2>13.2 <a name="132-glutget"></a>glutGet</h2>
...
<p>
<tt>int windowLeft = glutGet(GLUT_WINDOW_X);</tt></p>

<p>
These queries are with respect to the current window:</p>
...
including both border and caption (if any)</li>
	...
	<li>GLUT_WINDOW_RGBA - 1 if the color buffers are RGB, 0 for color index</li>
...
<p>
These queries do not depend on the current window.</p>
...
a call to <tt>glutInit</tt></li>
	<li>GLUT_VERSION - Return value will be X<i>10000+Y</i>100+Z where X is the
...
<h2>13.3 <a name="133-glutdeviceget"></a>glutDeviceGet</h2>

<h2>13.4 <a name="134-glutgetmodifiers"></a>glutGetModifiers</h2>

<h2>13.5 <a name="135-glutlayerget"></a>glutLayerGet</h2>

<h2>13.6 <a name="136-glutextensionsupported"></a>glutExtensionSupported</h2>

<h2>13.7 <a name="137-glutgetprocaddress"></a>glutGetProcAddress</h2>
...
<p>
<tt>void *glutGetProcAddress ( const char *procName );</tt></p>

<p>
<tt>procName</tt> Name of an OpenGL or GLUT function.</p>
...
to position characters.</p>

<p>
It should be noted that <i>freeglut</i> fonts are similar but not identical to GLUT fonts.
At the moment, <i>freeglut</i> fonts do not support the "<tt>" (backquote) and
"|" (vertical line) characters; in their place it renders asterisks.</tt></p>

<p>
<i>freeglut</i> supports the following bitmap fonts:</p>
...
It does not use any display lists in it rendering in bitmap fonts.</p>
...
width of a character and to render carriage returns when appropriate.</p>

<h2>14.1 <a name="141-glutbitmapcharacter"></a>glutBitmapCharacter</h2>

<p>
The <tt>glutBitmapCharacter</tt> function renders a single bitmapped
character in the <i>current window</i> using the specified font.</p>

<p>
<b>Usage</b></p>

<p>
<tt>void glutBitmapCharacter ( void *font,
int character );</tt></p>
...
from GLUT's position by a few pixels vertically and one or two pixels horizontally.</p>

<h2>14.2 <a name="142-glutbitmapstring"></a>glutBitmapString</h2>

<p>
The <tt>glutBitmapString</tt> function renders a string of bitmapped
characters in the <i>current window</i> using the specified font.</p>

<p>
<b>Usage</b></p>

<p>
<tt>void glutBitmapString ( void *font,
char *string );</tt></p>

<p>
<tt>font
</tt>The bitmapped font to use in rendering
the character string</p>
...
<h2>14.3 <a name="143-glutbitmapwidth"></a>glutBitmapWidth</h2>

<p>
The <tt>glutBitmapWidth</tt> function returns the width in pixels of
a single bitmapped character in the specified font.</p>

<p>
<b>Usage</b></p>

<p>
<tt>int glutBitmapWidth ( void *font,
int character );</tt></p>
...
<p>
The <tt>glutBitmapWidth</tt>
function returns the width of the given character in the specified bitmap
font. Because the font is bitmapped, the width is an exact integer.</p>
...
<h2>14.4 <a name="144-glutbitmaplength"></a>glutBitmapLength</h2>

<p>
The <tt>glutBitmapLength</tt> function returns the width in pixels of
a string of bitmapped characters in the specified font.</p>

<p>
<b>Usage</b></p>

<p>
<tt>int glutBitmapLength ( void *font,
char *string );</tt></p>

<p>
<tt>font </tt>The bitmapped
font to use in calculating the character width</p>
...
<p>
The <tt>glutBitmapLength</tt> function returns the width in pixels of the given character string in
...
<h2>14.5 <a name="145-glutbitmapheight"></a>glutBitmapHeight</h2>
...
<p>
<tt>int glutBitmapHeight ( void *font
);</tt></p>
...
<p>
The <tt>glutBitmapHeight</tt> function returns the height of a character in the specified bitmap font.
...
<h2>14.6 <a name="146-glutstrokecharacter"></a>glutStrokeCharacter</h2>

<p>
The <tt>glutStrokeCharacter</tt> function renders a single stroke character
in the <i>current window</i> using the specified font.</p>

<p>
<b>Usage</b></p>

<p>
<tt>void glutStrokeCharacter ( void *font, int character );</tt></p>

<p>
<tt>font</tt>The stroke font to use in rendering the character</p>

<p>
<tt>character</tt>The ASCII code of the character to be rendered</p>
...
<h2>14.7 <a name="147-glutstrokestring"></a>glutStrokeString</h2>

<p>
The <tt>glutStrokeString</tt> function renders a string of characters
in the <i>current window</i> using the specified stroke font.</p>

<p>
<b>Usage</b></p>

<p>
<tt>void glutStrokeString ( void *font,
char *string );</tt></p>
...
<h2>14.8 <a name="148-glutstrokewidth"></a>glutStrokeWidth</h2>

<p>
The <tt>glutStrokeWidth</tt> function returns the width in model units of
a single character in the specified stroke font, rounded to an int.</p>

<p>
<b>Usage</b></p>

<p>
<tt>int glutStrokeWidth ( void *font,
int character );</tt></p>
...
number; the function rounds it to the nearest integer for the return value.</p>
...
<h2>14.9 <a name="149-glutstrokewidthf"></a>glutStrokeWidthf</h2>

<p>
The <tt>glutStrokeWidthf</tt> function returns the width in model units of
a single character in the specified stroke font.</p>

<p>
<b>Usage</b></p>

<p>
<tt>GLfloat glutStrokeWidthf ( void *font,
int character );</tt></p>
...
function returns the width of the given character in the specified stroke
font. Function was included in an unreleased GLUT 3.8.</p>
...
<h2>14.10 <a name="1410-glutstrokelength"></a>glutStrokeLength</h2>

<p>
The <tt>glutStrokeLength</tt> function returns the width in model units of
a string of characters in the specified stroke font, rounded to an int.</p>

<p>
<b>Usage</b></p>

<p>
<tt>int glutStrokeLength ( void *font,
char *string );</tt></p>

<p>
<tt>font </tt>The stroke
font to use in calculating the character width</p>
...
<h2>14.11 <a name="1411-glutstrokelengthf"></a>glutStrokeLengthf</h2>

<p>
The <tt>glutStrokeLengthf</tt> function returns the width in model units of
a string of characters in the specified stroke font.</p>

<p>
<b>Usage</b></p>

<p>
<tt>GLfloat glutStrokeLengthf ( void *font,
char *string );</tt></p>
...
<h2>14.12 <a name="1412-glutstrokeheight"></a>glutStrokeHeight</h2>
...
<p>
<tt>GLfloat glutStrokeHeight ( void *font
);</tt></p>
...
glutSierpinskiSponge, glutTeapot, glutTeacup and glutTeaspoon.</p>
...
objects with shaders.</p>

<h2>15.1  <a name="151-glutwiresphere-glutsolidsphere"></a>glutWireSphere, glutSolidSphere</h2>

<p>
The <tt>glutWireSphere</tt> and <tt>glutSolidSphere</tt> functions
draw a wireframe and solid sphere respectively.</p>
...
<p>
<tt>dRadius</tt>  The desired radius of the sphere</p>

<p>
<tt>slices</tt>   The desired number of slices (divisions
in the longitudinal direction) in the sphere</p>

<p>
<tt>stacks</tt>   The desired number of stacks (divisions
...
<p>
The <tt>glutWireSphere</tt> and <tt>
...
<p>
None that we know of.</p>

<h2>15.2 <a name="152-glutwiretorus-glutsolidtorus"></a>glutWireTorus, glutSolidTorus</h2>

<p>
The <tt>glutWireTorus</tt> and <tt>glutSolidTorus</tt> functions draw
a wireframe and solid torus (donut shape) respectively.</p>
...
<p>
<tt>dInnerRadius</tt>  The radius of the tube.</p>

<p>
<tt>dOuterRadius</tt>  The distance from the center of the
Torus to the center of the tube.</p>

<p>
<tt>nSides</tt>        The desired number of segments in a
single outer circle of the torus</p>

<p>
<tt>nRings</tt>        The desired number of outer circles
...
<p>
The <tt>glutWireTorus</tt> and <tt>
...
<h2>15.3 <a name="153-glutwirecylinder-glutsolidcylinder"></a>glutWireCylinder, glutSolidCylinder</h2>

<p>
The <tt>glutWireCylinder</tt> and <tt>glutSolidCylinder</tt> functions draw
a wireframe and solid cone respectively.</p>
...
<p>
<tt>radius</tt>  The desired radius of the cylinder</p>

<p>
<tt>height</tt>  The desired height of the cylinder</p>

<p>
<tt>slices</tt>  The desired number of slices around
the cylinder</p>

<p>
<tt>stacks</tt>  The desired number of segments between
the base and the top of the cylinder (the number of points, including
the tip, is <tt>stacks + 1</tt>)</p>

<h2>15.4 <a name="154-glutwirecone-glutsolidcone"></a>glutWireCone, glutSolidCone</h2>
...
<p>
<tt>base</tt>    The desired radius of the base of the cone</p>

<p>
<tt>height</tt>  The desired height of the cone</p>
...
<h2>15.5 <a name="155-glutwirecube-glutsolidcube"></a>glutWireCube, glutSolidCube</h2>

<p>
The <tt>glutWireCube</tt> and <tt>glutSolidCube</tt> functions draw a
wireframe and solid cube respectively.</p>
...
<p>
<tt>dSize</tt>  The desired length of an edge of the cube</p>

<p>
<b>Description</b></p>

<p>
The <tt>glutWireCube</tt> and <tt>
...
<h2>15.6 <a name="156-glutwiretetrahedron-glutsolidtetrahedron"></a>glutWireTetrahedron, glutSolidTetrahedron</h2>
...
<p>
The <tt>glutWireTetrahedron</tt> and
...
<h2>15.7 <a name="157-glutwireoctahedron-glutsolidoctahedron"></a>glutWireOctahedron, glutSolidOctahedron</h2>

<p>
The <tt>glutWireOctahedron</tt> and <tt>glutSolidOctahedron</tt> functions
draw a wireframe and solid octahedron (eight-sided Platonic solid) respectively.</p>
...
<p>
The <tt>glutWireOctahedron</tt> and
...
<h2>15.8 <a name="158-glutwiredodecahedron-glutsoliddodecahedron"></a>glutWireDodecahedron, glutSolidDodecahedron</h2>
...
<p>
The <tt>glutWireDodecahedron</tt> and
...
eight of them coincide with the corners of a cube with sizes of length 2.</p>
...
<h2>15.9  <a name="159-glutwireicosahedron-glutsolidicosahedron"></a>glutWireIcosahedron, glutSolidIcosahedron</h2>
...
<h2>15.10 <a name="1510-glutwirerhombicdodecahedron-glutsolidrhombicdodecahedron"></a>glutWireRhombicDodecahedron, glutSolidRhombicDodecahedron</h2>
...
semi-regular solid) respectively.</p>
...
<p>
GLUT does not include these functions.</p>

<h2>15.11 <a name="1511-glutwireteapot-glutsolidteapot-glutwireteacup"></a>glutWireTeapot, glutSolidTeapot, glutWireTeacup,</h2>

<p>
glutSolidTeacup, glutWireTeaspoon, glutSolidTeaspoon</p>
...
wireframe and solid teaspoon.</p>
...
void&nbsp;glutSolidTeaspoon(double&nbsp;dSize);<br>
</tt></p>
...
<p>
<tt>dSize</tt>  The desired size of the teapot, teacup and
...
Vertex data retrieved from: <a href="ftp://ftp.funet.fi/pub/sci/graphics/packages/objects/teasetorig.gz">ftp://ftp.funet.fi/pub/sci/graphics/packages/objects/teasetorig.gz</a>.</p>

<p>
<b>Bugs</b></p>

<p>
OpenGL's default <tt>glFrontFace</tt> state assumes that front facing
...
<p>
GLUT only has the teapot and misses the rest of the teaset.</p>

<h2>15.12 <a name="1512-glutsetvertexattribcoord3-glutsetvertexattribnormal-glutsetvertexattribtexcoord2"></a>glutSetVertexAttribCoord3, glutSetVertexAttribNormal, glutSetVertexAttribTexCoord2</h2>
...
generated for the teapot, teacup and teaspoon.</p>
...
<p>
<tt>attrib</tt>  The index (address) of the vertex
attribute</p>
...
<h2>16.1 <a name="161-glutgamemodestring"></a>glutGameModeString</h2>
...
GameMode screen will be opened.</p>
...
the "x", ":" and "@" characters.</p>

<h2>16.2 <a name="162-glutentergamemode-glutleavegamemode"></a>glutEnterGameMode, glutLeaveGameMode</h2>
...
<tt>-display</tt> command line option to <tt>glutInit</tt>.</p>

<h2>16.3 <a name="163-glutgamemodeget"></a>glutGameModeGet</h2>
...
<p>
These functions are not implemented in <i>freeglut</i>.</p>

<h2>17.1 <a name="171-glutvideoresizeget"></a>glutVideoResizeGet</h2>

<h2>17.2 <a name="172-glutsetupvideoresizing"></a>glutSetupVideoResizing,</h2>

<p>
glutStopVideoResizing</p>

<h2>17.3 <a name="173-glutvideoresize"></a>glutVideoResize</h2>

<h2>17.4 <a name="174-glutvideopan"></a>glutVideoPan</h2>

<h1>18. <a name="ColorMap"></a>Color Map Functions</h1>

<h2>18.1 <a name="181-glutsetcolor-glutgetcolor"></a>glutSetColor, glutGetColor</h2>

<h2>18.2 <a name="182-glutcopycolormap"></a>glutCopyColormap</h2>
...
<h2>19.1 <a name="191-glutmultientryfunc-larr-id-glutenteredglutleft"></a>glutMultiEntryFunc &larr; id, GLUT_ENTERED|GLUT_LEFT</h2>

<h2>19.2 <a name="192-glutmultibuttonfunc-larr-id-x-y-button-glutdownglutup"></a>glutMultiButtonFunc &larr; id, x, y, button, GLUT_DOWN|GLUT_UP</h2>

<h2>19.3 <a name="193-glutmultimotionfunc-larr-id-x-y"></a>glutMultiMotionFunc &larr; id, x, y</h2>

<h2>19.4 <a name="194-glutmultipassivefunc-larr-id-x-y"></a>glutMultiPassiveFunc &larr; id, x, y</h2>
...
different (x,y,button,state instead of button,state,x,y).</p>

<p>
Currently, under X11, the non-multi callback variants are also called
on X11 for each event.</p>
...
<p>
All these functions have user-data callback functions.</p>

<p>
Limitation: currently on the cursor id is provided.  It may be
desirable to get the device id as well in the following situations:</p>
...
<p>
These new callbacks were added:</p>

<ul>
	<li><tt>glutInitContextFunc ← void</tt> : called when the context
is initialized or re-initialized (e.g. after a pause). Has user-data callback
function.</li>
	<li><tt>glutAppStatusFunc ← event</tt> : called when the
...
called after the <tt>glutInitContextFunc</tt> callback.</li>
</ul>
</li>
</ul>

<p>
Supported mobile platforms</p>
...
<h2>21.1 <a name="211-glutsetkeyrepeat-glutignorekeyrepeat"></a>glutSetKeyRepeat, glutIgnoreKeyRepeat</h2>
...
<p>
<tt>glutSetKeyRepeat's repeatMode</tt>
...
<h2>21.2 <a name="212-glutforcejoystickfunc"></a>glutForceJoystickFunc</h2>

<h2>21.3 <a name="213-glutreporterrors"></a>glutReportErrors</h2>
...
Your application's resource file should contain the line:</p>

<p>
<tt>GLUT_ICON   ICON    DISCARDABLE     "icon.ico"</tt>
where
...
define <tt>FREEGLUT_VERSION_2_0</tt>, <tt>FREEGLUT_VERSION_2_1</tt>, <tt>FREEGLUT_VERSION_2_2</tt>,
etc., but this was only done for <tt>FREEGLUT_VERSION_2_0</tt>.
...
The result will be X<i>10000+Y</i>100+Z where X is the major version, Y is the
minor version and Z is the patch level.</p>
